...
const fromMe = WABinary_1.isJidNewsletter(from) ? !!stanza.attrs?.is_sender : (0, WABinary_1.areJidsSameUser)(senderJid, meId) || (0, WABinary_1.areJidsSameUser)(senderJid, meLid)
